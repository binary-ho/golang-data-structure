...
func (t *Tree[V]) inorderIndexing(node *Node[V], currentIndex *int, nodeIndices map[*Node[V]]int) {
	if node == nil {
		return
	}
...
func (t *Tree[V]) print(node *Node[V], prefix string, isLeft bool, sb *strings.Builder, nodeIndices map[*Node[V]]int) {
	if node == nil {
		return
	}
